window.ThemeManager = (function () {
    ...
    themeManager.bodyFontColor = ko.observable("#999");
    themeManager.radius = ko.observable("4px");
    themeManager.badgeRadius = ko.observable("9px");
    themeManager.bodyBackgroundColor = ko.observable("#121417");
    themeManager.bodyGradientFromColor = ko.observable("#060606");
    themeManager.bodyGradientToColor = ko.observable("#252a30");
    themeManager.infoColor = ko.observable("#33b5e5");
    themeManager.badgeSuccess = ko.observable("#669900");
    themeManager.badgeWarning = ko.observable("#f80");
    themeManager.codeColor = ko.observable("#fff");
    themeManager.hoverColor = ko.observable("#33b5e5");
    themeManager.wellBackgroundColor = ko.observable("#131517");
    themeManager.navBackgroundColor = ko.observable("#020202");
    themeManager.navBarInnerBackgroundColor = ko.observable("#252a30");
    themeManager.inverseColor = ko.observable("#9933CC");
    themeManager.successColor = ko.observable("#5c8a00");
    themeManager.errorColor = ko.observable("#c00");
    themeManager.completedColor = ko.observable("#5c8a00");
    themeManager.tableBorderColor = ko.observable("#222");

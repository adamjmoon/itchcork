...
define("BenchmarkModel", ['knockout'], function (ko) {
    var vm = function () {
...
define("SuiteView", ['ThemeManager', 'UnitTestFrameworkManager', 'knockout', 'jquery'], function (ThemeManager, utfm, ko, $) {
    function view() {
...
//            self.setupNiceScroll();
        ...
        self.setupNiceScroll = function () {
            ...
            $("#itchcorkWrapper").niceScroll("#suiteListAccordian",{cursorcolor:"#0F0",  railpadding: {top:0,right:20} });
        };

        self.highlight = function () {
            $("#itchcorkWrapper").localScroll({target: '#itchcorkWrapper', lazy: true});
        };
    ...
    window.suiteView = new view();


    return view;
});

define("SuiteViewModel", ['benchmark', 'BenchmarkModel', 'knockout'], function (Benchmark, bVM, ko) {
    var vm = function () {
        var self = this;
        this.num = 0;
...
define('ThemeManager', function () {
    ...
    themeManager['cyborg'].bodyFontColor = "#fff";
    ...
    themeManager['cyborg'].wellBorderColor = "#131517";
    ...
    themeManager['cosmo'].bodyFontColor = "#fff";
    ...
    themeManager['curelean'].bodyFontColor = "#fff";
    ...
    themeManager['curelean'].wellBorderColor = "#fff";
    ...
    var apply = function () {
        ...
        themeStyleTag.innerHTML = "body{margin: 0;font-family:"+ t.codeFontFamily + ";font-size:"
            ...
            + t.tableBorderColor + "}.table th{font-weight:bold}.table thead th{vertical-align:bottom}.table caption+thead tr:first-child th,.table caption+thead tr:first-child td,.table colgroup+thead tr:first-child th,.table colgroup+thead tr:first-child td,.table thead:first-child tr:first-child th,.table thead:first-child tr:first-child td{border-top:0}.table tbody+t.results{border-top:2px solid #222}.table .table{background-color:"
            ...
            + t.wellBackgroundColor + ";border:1px solid"
            + t.wellBorderColor + ";border:1px solid rgba(0,0,0,0.2);*border-right-width:2px;*border-bottom-width:2px;-webkit-border-radius:6px;-moz-border-radius:6px;border-radius:6px;-webkit-box-shadow:0 5px 10px rgba(0,0,0,0.2);-moz-box-shadow:0 5px 10px rgba(0,0,0,0.2);box-shadow:0 5px 10px rgba(0,0,0,0.2);-webkit-background-clip:padding-box;-moz-background-clip:padding;background-clip:padding-box}.dropdown-menu.pull-right{right:0;left:auto}.dropdown-menu .divider{*width:100%;height:1px;margin:9px 1px;*margin:-5px 0 5px;overflow:hidden;background-color:transparent;border-bottom:1px solid "
            ...
            + t.bodyFontColor + "}code,pre{background-color:#eee}blockquote{border-left:5px solid #222}blockquote.pull-right{border-right:5px solid #222}html{min-height:100%}.results{min-height:100%;background-color: "
            ...
            + "@media screen and (max-width:60em){.results{ font-weight: 10px !important;} pre code{font-size:8pt}code{font-size:8pt}.js{width:100% !important;}div.well.coffee{width:100% !important;margin-left:0px !important;}.accordion-inner{padding: 5px 1px 0px 1px  !important;}}"
            ...
            + ".suiteDesc{padding:2px!important; height: 55px; margin-bottom: 2px !important;}.run-again{margin-left:4px!important}.navbar .btn,.navbar .btn-group{margin-top:10px}pre.well {border: none;overflow-x: auto;}.frame{overflow-y: auto !important;}"
